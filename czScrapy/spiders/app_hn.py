...
class AppHnSpider(scrapy.Spider):
    name = 'app_hn'
    allowed_domains = ['hn.jxzbtb.cn']
    start_urls = ['http://hn.jxzbtb.cn/jygg/1.html']
    base_url = 'http://hn.jxzbtb.cn'
        ...
        for node in node_list:
            ...
            if page_now == 1 and nowItem == 0:
                ...
                send_email(receiver=['16396355@qq.com', '8206741@163.com'],
                           ...
                           title=self.curr_time + '嘉兴海宁市招标网站',
                           cont='<h1>今日爬取地址{}\r\n<br>嘉兴海宁市招标网站最新更新日期是{}</h1>'.format(response.url + "\r\n",
                                                                                     self.newday))
            nowItem += 1
...
if __name__ == "__main__":
    cmdline.execute("scrapy crawl app_hn".split())