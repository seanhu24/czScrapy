...
class AppZhujiSpider(scrapy.Spider):
    name = 'app_zhuji'
    allowed_domains = ['zhuji.gov.cn']
    newEndcode = "utf-8"
    urls = ['www.zhuji.gov.cn/col/col1679846/index.html?uid=5057613&pageNum=1','www.zhuji.gov.cn/col/col1679845/index.html?uid=5057605&pageNum=1']
    def start_requests(self):
        ...
        #logging.info("现在爬取第{}页内容".format(self.nowpage))
            yield scrapy.FormRequest(
                url='http://www.zhuji.gov.cn/module/jpage/dataproxy.jsp?startrecord=0&endrecord=100000&perpage=999',
                formdata={
...
if __name__ == "__main__":
    cmdline.execute("scrapy crawl app_zhuji".split())